...
export default function Header() {
     ...
     console.log("🚀 ~ Header ~ lightTheme:", lightTheme)
          ...
          >
               ...
               <div className="themeChanger flex items-center gap-3">
                    {/* <div className="hamburger border-2 ">
                         <input type="checkbox" id="checkbox" className="absolute left-0 w-[40px]" />
                         <div for='checkbox' className={"label w-5 bg-black h-1"}></div>
                    </div> */}
                    <MaterialUISwitch
                         checked={isDark}
